...
/* (13) = (c) ; FSW */
/* (14) = (d) ; FSN */
void * EF_CDECL operator new( EF_SIZE_T )                             ;
void * EF_CDECL operator new( EF_SIZE_T , const std::nothrow_t & )    ;
void   EF_CDECL operator delete( void * )                             ;
void   EF_CDECL operator delete( void * , const std::nothrow_t & )    ;
...
/* (33) = (c) ; FSW */
/* (34) = (d) ; FSN */
void * EF_CDECL operator new( EF_SIZE_T, const char *, int )                         ;
void * EF_CDECL operator new( EF_SIZE_T, const std::nothrow_t &, const char *, int ) ;
void   EF_CDECL operator delete( void *, const char *, int )                         ;
void   EF_CDECL operator delete( void *, const std::nothrow_t &, const char *, int ) ;
